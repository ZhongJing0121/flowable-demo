...
public class FlowableTest {
    ...
    private static final String JDBC_URL = "jdbc:mysql://121.40.59.111:3306/go-demo?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC";
    private static final String JDBC_USERNAME = "zhongjing";

    private static final String JDBC_PASSWORD = "zhongjing0121";
    ...
    public void testDeployQuery(){
        ...
        ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery()
                .deploymentId("5001")
                .processDefinitionResourceNameLike("2023-请假流程.bpmn20.xml")
                .processDefinitionName("2023-请假流程")
                .singleResult();

        ProcessDefinition processDefinition2 = repositoryService.createProcessDefinitionQuery()
                .deploymentId("holidayFlowable:3:5004")
                        .singleResult();
